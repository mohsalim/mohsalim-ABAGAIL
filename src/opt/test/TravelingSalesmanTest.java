...
public class TravelingSalesmanTest {
    ...
    public static void main(String[] args) {
        ...
        oa[1] = new SimulatedAnnealing(1E12, .95, hcp);
        oa[2] = new StandardGeneticAlgorithm(200, 150, 20, gap);
        oa[3] = new MIMIC(200, 100, pop);
        for(int i = 0; i < oa.length; i++) {
        	RunLogFitnessFunction.run(
        			oa[i], 
        			oaNames[i], 
        			1000, 
        			"MIMIC".equals(oaNames[i]) ? ef2 : ef, 
        			"traveling-salesman");
        }
        ...
        fit.train();
        System.out.println("MIMIC: " + ef2.value(mimic.getOptimal()));
